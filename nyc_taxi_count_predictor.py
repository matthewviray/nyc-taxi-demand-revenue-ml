...
# Load lookup CSV
lookup_zone = pd.read_csv('NYC_data/taxi_zone_lookup.csv')
...
# Brief description
st.title("NYC Taxi Ride Count Predictor")
st.write("""
Predict the number of NYC taxi rides based on factors like time of day, day of week, 
weather conditions, and location. Explore patterns and make data-driven predictions 
for ride demand.
""")
# Streamlit inputs
